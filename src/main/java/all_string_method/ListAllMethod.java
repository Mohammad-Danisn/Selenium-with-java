...
public class ListAllMethod {
    public static void main(String[] args) {
        ...
        // add the elements of l2 at the starting of l1 by typing :
        //L1.addAll(0,l2);
        ...
        //Similarly, I also find the index of the last occurrence of an element with the help of the lastIndexOf() method.
        System.out.println("L1 Array list : "+ l1);
